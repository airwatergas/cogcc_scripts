...
begin
  ...
  begin
    ...
    search_form.field_with(name: 'Date2').value = '12/31/2008'
#    search_form.field_with(name: 'Date1').value = '01/01/2009'
#    search_form.field_with(name: 'Date2').value = '09/18/2015'
    ...
    results_table.css('tr').each_with_index do |tr,i|
      ...
      if i >= 2 then
        ...
        s = SpillReleases.new
      	...
      	s.fac_id_api_num = tr.xpath('td[3]').text.gsub(nbsp, " ").strip
